...
- Her çekim DepoHareket kaydı bırakır
"""
from decimal import Decimal
from typing import Optional, List, Tuple
from sqlalchemy.orm import Session
from app.models.models import HammaddeLot, DepoStok, DepoHareket, LotDurum, DepoHareketTip
...
def fifo_cek(
    ...
    referans_id: Optional[int],      # uretim_emri_id veya başka referans
    referans_tip: str,               # "uretim", "transfer" vb.
    ...
    if kalan > 0:
        db.rollback()
        return False, [], f"Yetersiz stok. {float(kalan):.3f} eksik."
